...
public class PlaceBetServiceImpl implements PlaceBetService{
    ...
    private static final Logger log = LoggerFactory.getLogger(PlaceBetServiceImpl.class);
    private final UserRepository userRepository;
    private final CheckUserBalance checkUserBalance;
    ...
    public Response<TransactionCallBackResponse> placebetConfig(CallBackRequest data) {
        ...
        if (!SignUtil.verifySignature(data.getOperatorCode(), data.getRequestTime(), "withdraw", constantDataObj.getSecretKey(), data.getSign())) {
